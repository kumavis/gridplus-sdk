...
export class Client {
   ...
   * @param [cachedData=null] - This is the cached data from the previous request. If this is null,
   * @param [nextCode=null] - the next code to send to the device. This is only used if there are
   ...
   * @param [nextCode=null] - If this is a follow-up request, we don't need to ask for user
   * authorization
  ...
  */
   ...
   * @param [req=null] - The original request data
