...
export class Client {
   ...
   */
  private test (data: { payload: any, testID: number }, cb: (a, b?) => any) {
    if (!data.payload)
   ...
   */
  public sign (opts: { currency, data }, cb, cachedData = null, nextCode = null) {
    const { currency } = opts;
    let { data } = opts;
